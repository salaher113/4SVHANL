...
import com.example.joy_tv.streamengine.utils.MyCookieJar
...
object MEGAKinoProvider : Provider {
    ...
    override suspend fun getGenre(id: String, page: Int): Genre {
        ...
        return Genre(id, genreName, items.filterIsInstance<com.example.joy_tv.streamengine.models.Show>())
    }
    ...
    override suspend fun getPeople(id: String, page: Int): People {
        ...
        val filmography = parseContentItems(document).filterIsInstance<com.example.joy_tv.streamengine.models.Show>()
