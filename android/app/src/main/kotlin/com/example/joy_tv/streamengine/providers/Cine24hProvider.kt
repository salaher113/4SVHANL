...
import com.example.joy_tv.streamengine.utils.NetworkClient
import com.example.joy_tv.streamengine.utils.WebViewResolver
...
object Cine24hProvider : Provider {
    ...
    private suspend fun getDocument(url: String): Document {
        ...
        val resolver = webViewResolver ?: WebViewResolver(StreamEngine.context)
